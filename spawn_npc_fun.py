...
def spawn_npc(fps):
    ...
    for n, transform in enumerate(spawn_points):
        ...
        vehicle = SpawnActor(blueprint, transform).then(SetAutopilot(FutureActor, True, traffic_manager.get_port())).then(SetVehicleLightState(FutureActor, light_state))
    ...
    print('spawned %d vehicles and %d walkers, press Ctrl+C to exit.' % (len(vehicles_id), len(walkers_list)))
    """
    ...
    #     print('\ndestroying %d vehicles' % len(vehicles_id))
